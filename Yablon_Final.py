...
def find_odds_basic():  
  ...
  # Going through full deck and checking % of cards which are "in"
    ...
    print ('% Chance between:',in_odds,'while', '% Chance not between:',out_odds)
...
def Assisted_Deluxe_Acey_Ducey():
    ...
    button_player_1 = Button(newWindow, text = "1 Player", command = player_1_deluxe_assisted, font= 'castellar 12 bold')
    button_player_1.pack(pady = 10)
    button_player_1.bind("<Enter>", on_enter)
    button_player_1.bind("<Leave>", on_leave)
...
btn_4 = Button(master, text =" ASSISSTED DELUXE ACEY DUCEY", command = Assisted_Deluxe_Acey_Ducey, activebackground="#87C1FF", activeforeground="#fff", font= 'castellar 12 bold')
btn_4.pack(pady = 10)
